...
public class rightImage_jsp extends HttpJspBase {
...
back_url_home = back_url_home.substring(0,back_url_home.lastIndexOf("/"))+"/index.do";
      ...
      if (_jspx_meth_c_out_3(pageContext))
        return;
      out.write("/images/main/main_right.gif');background-attachment: fixed; background-repeat: repeat; background-position: right top\">\n");
      out.write("</body>\n");
      out.write("</html>");
    } catch (Throwable t) {
      out = _jspx_out;
