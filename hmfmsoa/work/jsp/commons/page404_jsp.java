...
public class page404_jsp extends HttpJspBase {
  ...
  private boolean _jspx_meth_html_html_0(javax.servlet.jsp.PageContext pageContext)
    ...
    if (_jspx_eval_html_html_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("<table align=\"center\"   class=\"grid1\"  align=\"center\"  border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"80%\" >\r\n\t\t    \t");
        out.write("<thead>");
        out.write("<tr>");
        out.write("<td>");
        out.write("<div align=\"center\">页面不存在!");
        out.write("</div>");
        out.write("</td>");
        out.write("</tr>");
        out.write("</thead>\r\n\t\t        ");
        ...
        out.write("<table  align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"300\">\r\n\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t");
        out.write("<tr>\r\n\t\t\t\t\t\t\t");
