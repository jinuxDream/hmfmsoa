...
<input type="hidden" id="selectedUserid" value="" /> 
      <table width="680" align="center" border="0" cellpadding="0" cellspacing="1">
        <tr><td><div class="headline"><div class="headarrow">&nbsp;</div>角色管理→新增</div></td></tr>
          ...
          <td>
                 ...
                 <table class="grid1" width="100%" >
                    ...
                    <tr>
                      ...
                      <td width="80%" height="23" align="left" nowrap>
                        <input type="text" class="text" size="20" name="ro_name" maxlength="40" title="角色名称"/>
                        <span>
                          <font color="red">
                            *
                          </font>
                    ...
                    <tr>
                      ...
                      <td nowrap height="23" width="80%" align="left">
                        <textarea name="ro_desc" cols="60" maxlength="256" class="emptytextarea" title="&#25551;&#36848;" rows="2" title="描述"></textarea>
                      </td>
                    </tr>
                  </table>
              </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr>
                <td align="center">
                <div>
				  <button  type="button" class="btn" value="1" btn_href="addroleok.do" istip="1" mask>保存</button>
