...
<html>
	...
	<body>
		<form name="form1" method="post" action="">
			...
			<tr><td align="left"><div class="headline"><div class="headarrow">&nbsp;</div>用户系统→新增</div></td></tr>	
			<tr><td align="left">
				<button class="btn" type="button" value="1" btn_href="save.do">保存</button>
						...
						<tr>
							<td align="left" width="100%">
								<table class="grid_fixhead" width="100%" border="0">
									<tr>
										<td align="right" width="150">系统编号：<span><font color="red">(必填)</font></span></td>
										<td align="left"><input name="sn_id" id="sn_id" type="text"   v_empty="1" size="20"/></td>
									</tr>
									<tr>
										<td align="right" width="150">系统名称：<span><font color="red">(必填)</font></span></td>
